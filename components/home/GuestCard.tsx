...
const GuestCard = (props: PropsInteface) => {
    ...
    return (
        ...
        >
            <figure className="relative aspect-square w-[80dvw] sm:w-[60dvw] md:w-[50dvw] lg:w-[25dvw]">
                <Image
                    src={imageUrl}
                    alt={name}
                    fill
            ...
            <div className="flex flex-col gap-3 w-full lg:w-[50dvw] xl:w-[45dvw] 2xl:w-[40dvw] text-clip bg-site-main/80 text-white justify-center h-fit p-5">

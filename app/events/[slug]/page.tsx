        ...
        return (
            <div className="min-h-screen bg-white flex items-center justify-center">
                <div className="text-center">
                    ...
                    <Link
                        href="/"
                        className="bg-site-main text-white px-8 py-1.5 sm:px-12 sm:py-2 rounded-full sm:text-lg md:text-xl font-bold hover:bg-site-main/75 transition-transform duration-200 hover:scale-110 shadow-lg hover:shadow-xl"
                    >
                        Back to Home
                    </Link>
                </div>
        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="max-w-6xl mx-auto px-4 py-8">
                <div className="flex flex-col md:flex-row items-start md:items-center mb-8">
                    <figure className="relative aspect-square w-40 sm:w-48 md:w-52 lg:w-64 xl:w-80">
                        <Image
                            src={event.imageUrl}
                            alt={event.eventName}
                            fill
                    ...
                    <div className="flex-1">
                        ...
                        <Link
                            ...
                            className="bg-site-main text-white px-8 py-1.5 sm:px-12 sm:py-2 rounded-full sm:text-lg md:text-xl font-bold transition-transform duration-200 hover:scale-110 shadow-lg hover:shadow-xl inline-block"
                        >
                            REGISTER NOW!
                        </Link>
                    </div>
                ...
                <div className="flex justify-center my-8">
                    <button
                        ...
                        className="bg-site-main text-white p-3 rounded-full transition-transform duration-200 hover:scale-110"
